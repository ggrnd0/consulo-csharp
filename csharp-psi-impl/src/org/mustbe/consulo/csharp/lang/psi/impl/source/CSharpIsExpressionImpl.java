...
import org.mustbe.consulo.csharp.lang.psi.CSharpIsExpression;
 ...
 * @since 04.01.14.
 */
public class CSharpIsExpressionImpl extends CSharpElementImpl implements CSharpIsExpression
{
	...
	{
		return visitor.visitIsExpression(this, p);
	}
